import { questionnaires, rawQuestionnaires, apQuestionBankStats, apRecoveryBatch5, apRecoveryBatch6, apRecoveryBatch7, apRecoveryBatch8, apRecoveryBatch9, apRecoveryBatch10, apRecoveryBatch11 } from "@/data/questionnaires";
import {
  toeflQuestions,
  satQuestions,
...
for (const [label, batch] of [["5", apRecoveryBatch5], ["6", apRecoveryBatch6], ["7", apRecoveryBatch7], ["8", apRecoveryBatch8], ["9", apRecoveryBatch9], ["10", apRecoveryBatch10], ["11", apRecoveryBatch11]] as const) {
