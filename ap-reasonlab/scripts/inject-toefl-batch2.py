#!/usr/bin/env python3
"""Inject TOEFL batch-2 reading/writing/listening/speaking/vocab documents."""
...
def main() -> None:
    rw = load_attr("_toefl_batch2_reading_writing.py", "BATCH2_RW")
    ls = load_attr("_toefl_batch2_listening_speaking.py", "BATCH2_LS")
