      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="mt-4 rounded-2xl border border-brand-200 bg-brand-50/80 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:gap-4">
            ...
            <Link
              href="/ap/writing-frameworks"
              className="mt-3 inline-flex shrink-0 rounded-xl border border-brand-300 bg-white px-4 py-2 text-sm font-semibold text-brand-800 hover:bg-brand-50 sm:mt-0"
            >
              Writing frameworks →
            </Link>
          </div>
