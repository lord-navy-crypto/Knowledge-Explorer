...
export default function DownloadPage() {
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-3 rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50/70 via-white to-slate-50 px-5 py-6 sm:px-7">
        <p className="text-xs font-semibold uppercase tracking-[0.18em] text-brand-600">Download</p>
        ...
        <p className="text-xs text-slate-500">{DOWNLOADS.length} macOS builder packages</p>
      </section>
