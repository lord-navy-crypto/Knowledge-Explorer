...
export const trademarkDisclaimer =
  "AP®, Advanced Placement®, College Board®, and SAT® are trademarks of the College Board. TOEFL® is a trademark of ETS. Liji Explore is an independent study site and is not affiliated with or endorsed by those organizations.";

export const copyrightDisclaimer =
  "AP® / College Board® trademarks and related branded materials remain the property of their respective owners. Liji Explore does not claim ownership of College Board content.";

export const originalSourcesDisclaimer =
  "Study materials on this site — notes, worksheets, textbooks, images, PDFs, vocabulary lists, practice sets, and similar content — remain the property of their original authors, publishers, schools, or other rightsholders. Liji Explore does not claim ownership of third-party material. If content appears here from another source, copyright stays with that source.";
...
export const siteOwnsDisclaimer =
  "Liji Explore only claims ownership of its own original site UI, branding, and clearly site-created examples. Everything else belongs to its original source or trademark owner.";
