...
export const TOOL_CLUSTERS: ToolCluster[] = [
  ...
  },
  {
    ...
    blurb: "Calculator + grapher + calc lab (d/dx, f″, tangent Y2, ∫, average, Riemann, Σ, table, zeros) plus units, sci notation, vectors, LaTeX, and the formula board on one desk. Catalog cards stay listed.",
