...
export const TOOL_WORKBENCHES: ToolWorkbench[] = [
  ...
  },
  {
    ...
    blurb:
      "One programming workspace with the code utilities already integrated into the editor.",
    href: "/code/editor?lang=python",
    moduleIds: ["code-board", "json-formatter", "encode-decode"],
    capabilityLabel: "Editor · Code board · JSON · Base64/URL",
  },
  {
    id: "write",
    title: "Write & convert workbench",
    blurb:
      "Draft, edit, compare, count and convert writing from one workbench instead of separate catalog products.",
    href: "/tools/workbench/write",
    moduleIds: [
      "write-convert",
      "dual",
      "draft",
    ...
    capabilityLabel: "Edit · Draft · Compare · Count · Markdown · Word import · PDF export",
  },
  {
    id: "files",
  ...
  },
  {
    ...
    blurb:
      "Focus and review tools are grouped into one study desk instead of separate catalog products.",
  ...
  },
  {
    ...
    blurb:
      "Small classroom helpers and reusable presets are collected into one lightweight workbench.",
    href: "/tools/workbench/classroom",
    moduleIds: ["random-groups", "qr-code", "color-contrast", "short-code"],
    capabilityLabel: "Groups · QR · Color/contrast · Presets",
  },
  {
    id: "ai",
    title: "AI workbench",
