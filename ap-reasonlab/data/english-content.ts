...
export const toeflQuestions: EnglishPracticeQuestion[] = [
  ...
  { id: "toefl-7", skill: "Vocabulary in context", prompt: "The committee’s decision was described as ___ because it settled a dispute that had lasted for years.", choices: ["tentative", "decisive", "ambiguous", "irrelevant"], answer: 1, explanation: "A decision that settles a long dispute is best described as decisive." },
];
...
export const satQuestions: EnglishPracticeQuestion[] = [
  ...
  { id: "sat-8", skill: "Punctuation", prompt: "Which sentence is correctly punctuated?", choices: ["After the trial ended the team analyzed the data.", "After the trial ended, the team analyzed the data.", "After the trial ended; the team analyzed the data.", "After the trial ended: the team analyzed the data."], answer: 1, explanation: "An introductory dependent clause is followed by a comma before the main clause." },
];
