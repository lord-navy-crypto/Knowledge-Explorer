...
export const SITE_SECTION_FOLDERS: SiteSectionFolder[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { area: "code-c", space: ROOT_SPACE, label: "C", href: "/code/c" },
      { area: "code-cpp", space: ROOT_SPACE, label: "C++", href: "/code/cpp" },
      { area: "code-go", space: ROOT_SPACE, label: "Go", href: "/code/go" },
      { area: "code-rust", space: ROOT_SPACE, label: "Rust", href: "/code/rust" },
      { area: "code-php", space: ROOT_SPACE, label: "PHP", href: "/code/php" },
      { area: "code-ruby", space: ROOT_SPACE, label: "Ruby", href: "/code/ruby" },
      { area: "code-r", space: ROOT_SPACE, label: "R", href: "/code/r" },
      { area: "code-swift", space: ROOT_SPACE, label: "Swift", href: "/code/swift" },
      { area: "code-kotlin", space: ROOT_SPACE, label: "Kotlin", href: "/code/kotlin" },
    ],
  },
  {
    id: "forum",
...
export function collectDynamicPageFolders(
  ...
  // Skip ghost pages for folders the user already deleted (id tombstone only — no cascade).
