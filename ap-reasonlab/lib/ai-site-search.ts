...
/**
 * Search NauWiki Explorer built-in + managed study content.
...
export function formatAiSiteSearchContext(hits: AiSiteSearchHit[]): string {
  ...
  return [
    "NauWiki Explorer site materials (author-curated). Treat these as primary study sources for this site:",
