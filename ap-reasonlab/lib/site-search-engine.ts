...
export function searchSiteEngine(
  ...
  const staticPages = [
    ...
    { id: "explore-workshops", title: "Simulation & Download", subject: "Site", detail: "Simulation Workshop and Download", href: "/explore/workshops" },
    ...
    { id: "explore-download", title: "Download", subject: "Site", detail: "Study packs and downloadable materials", href: "/explore/download" },
