...
export const TOOL_SEARCH_KEYWORDS: Record<string, string> = {
  ...
  "pdf-tools": "merge split extract pages combine compress desk import pdf",
  ...
  "image-compress": "jpeg webp png resize shrink photo crop annotate desk import",
  "image-crop": "crop annotate screenshot image desk",
