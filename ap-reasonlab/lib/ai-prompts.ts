...
- English (/english): Hub split into three lanes — (1) Exams: TOEFL daily materials (upload reading articles, listening scripts + machine replay, writing prompts/范文, speaking dialogue shadow) and SAT practice-set folders; (2) Skills for real English: Vocabulary, Grammar & Sentences, Writing, plus local practice tools (vocab book, speech-to-text mic/file, dictation, paraphrase, reading highlights); (3) English AI Tutor kept at /english/ai → AI Toolbox English.
