...
Site name: NauWiki Explorer — academic platform (tutor, not solver).
Home portal title: Knowledge Explorer — four gateway boxes on / ; AI Toolbox stays in the top bar.
Main boxes:
...
- AI Toolbox (/hints): Always in the top nav. One unified AI panel — prefer Local AI when WebGPU is available; also Website API or Your own API. Then pick AP / English / Coding tasks. Always search NauWiki Explorer before answering. Extra tools: Calculator (computer) and Grapher (function plotter).
