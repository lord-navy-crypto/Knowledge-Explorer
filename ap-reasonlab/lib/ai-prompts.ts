...
- Code (/code): browser playgrounds for Python (Pyodide), JavaScript, TypeScript, Web/HTML, SQL (sql.js), Markdown; Java is snippets/uploads only (no in-browser runner yet). Long code block adder at /tools/code-board.
