...
const CORE_STATIC_PAGES: Array<Omit<StaticCorpusRow, "body">> = [
  ...
  { id: "about", type: "page", title: "About", subject: "Site", detail: "About Knowledge Explorer and beta tester feedback form", href: "/about" },
  { id: "checklist", type: "page", title: "Project checklist", subject: "Site", detail: "Launch checklist and beta feedback link", href: "/checklist" },
  { id: "forum-beta", type: "page", title: "Beta feedback · Forum", subject: "Community", detail: "Tester feedback threads tagged #beta-feedback", href: "/forum?tag=beta-feedback" },
